...
namespace RegisterProtectionDemo.Sdk
{
    ...
    {
        public static string VERIFY_API = "https://ac.dun.163yun.com/v1/register/check"; // verify接口地址
        ...
        public RegisterAntiCheatVerifier( NESecretPair secretPair, string businessID)
        {
        ...
        public VerifyResultType verify(string token)
        {
            ...
            //parameters.Add("Ip", "123.123.123.120");
            //parameters.Add("nickname", "abc");
